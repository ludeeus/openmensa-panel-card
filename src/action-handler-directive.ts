...
customElements.define('action-handler-openmensa', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-openmensa')) {
    return body.querySelector('action-handler-openmensa') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-openmensa');
